...
export const CardPerfil = () => {
    ...
    return (
        <div className="bg-white border border-slate-200 p-4 flex flex-col items-center justify-center h-full shadow-xl rounded-lg mb-8 mx-auto">
            <div>
                <img src="https://cdn-icons-png.flaticon.com/512/1144/1144760.png" alt="img-client" className="m-auto " width={120} height={120} />
            </div>
